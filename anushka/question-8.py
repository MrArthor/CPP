...
print("Simple K-Means Clustering Result:")
...
print("Number of samples per cluster in Hierarchical Clustering:")
print(pd.Series(clustering.labels_).value_counts())
print("Heirarchical Clustering Result:")
...
plt.xlabel("Sepal Length")
plt.ylabel("Sepal Width")
plt.title("HIERARCHICAL (AGNES) CLUSTERING")
plt.show ()
